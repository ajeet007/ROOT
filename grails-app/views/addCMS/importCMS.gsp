...
<div id="div1"  style="padding: 0px; margin-left:auto;margin-right:auto; height: 500px; font-family: verdana; font-size: 12px; color: #FFFFFF; text-decoration: none; background-color: #5776AC">
    ...
    <div style="margin-left:auto;margin-right:auto;background-color:#E0EBF8;top:40px;width:750px" align="center">
        <fieldset style="color:Black" ><legend>Add CMS</legend>
            <div class="nav">
            ...
            <div class="body">
                <g:form  id="save" name="save">
                    ...
                    <div id="updte1">
                        <table align="center">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top">
                                    <g:textField style="background-color: #f5f5f5;width: 210px;" name="cmsName" id="cmsName" value="" autofocus="autofocus"/>
                                </td>

                            </tr>
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label>ContentOwner ID</label>
                                </td>
                                <td valign="top">
                                    <g:textField style="background-color: #f5f5f5;width: 210px;" name="cmsCode" id="cmsCode"  value="" autofocus="autofocus"/>
                                </td>
                    ...
                    <div  style="padding-top: 25px;padding-left: 175px;float: left;">
                        <span class="button"><input type="button" style="width: 120px;" id="cms_project" class="X"
